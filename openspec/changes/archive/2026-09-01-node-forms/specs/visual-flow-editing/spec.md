...
- **WHEN** se edita un campo cuyos valores no los declara el esquema sino la base de datos, como
  la troncal del nodo de entrada
- **THEN** se edita con el control propio de ese campo en vez de con un control genérico
